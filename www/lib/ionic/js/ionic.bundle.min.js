...
function(b){return b&&b.$$intervalId in e?(e[b.$$intervalId].reject("canceled"),a.clearInterval(b.$$intervalId),delete e[b.$$intervalId],!0):!1};return d}]}function bd(){this.$get=function(){return{id:"en-us",NUMBER_FORMATS:{DECIMAL_SEP:",",GROUP_SEP:"\u00a0",PATTERNS:[{minInt:1,minFrac:0,maxFrac:3,posPre:'',posSuf:'',negPre:'-',negSuf:'',gSize:3,lgSize:3},{minInt: 1,minFrac:2,maxFrac:2,posPre:'',posSuf:'\u00a0\u00a4',negPre:'-',negSuf:'\u00a0\u00a4',gSize:3,lgSize:3}],CURRENCY_SYM:"€"},DATETIME_FORMATS:{MONTH:"janvier f\u00e9vrier mars avril mai juin juillet ao\u00fbt septembre octobre novembre d\u00e9cembre".split(" "),
SHORTMONTH:"janv. f\u00e9vr. mars,avr. mai juin juil. ao\u00fbt sept. oct. nov. d\u00e9c.".split(" "),DAY:"dimanche lundi mardi mercredi jeudi vendredi samedi".split(" "),SHORTDAY:"dim. lun. mar. mer. jeu. ven. sam.".split(" "),AMPMS:["AM","PM"],medium:"d MMM y HH:mm:ss","short":"dd/MM/y HH:mm",fullDate:"EEEE d MMMM y",longDate:"d MMMM y",mediumDate:"d MMM y",shortDate:"dd/MM/y",mediumTime:"HH:mm:ss",shortTime:"HH:mm"},pluralCat:function(b){return 1===b?"one":"other"}}}}function Qb(b){b=b.split("/");for(var a=b.length;a--;)b[a]=
